...
export default function DashboardClient() {
  ...
  return (
    <main className="max-w-5xl mx-auto p-4 sm:p-6 md:p-12 space-y-5 md:space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Progress Graph */}
      <section aria-label="Study progress graph" className="glass rounded-2xl overflow-hidden">
        <ProgressGraph history={history || []} trackerData={trackerData} />
      </section>

      {/* Stats Grid with Glassmorphism */}
      <section aria-label="overall statistics" className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {[
      ...
      <section id="subjects" aria-label="Subject progress" className="glass rounded-2xl overflow-hidden scroll-mt-20">
              ...
              >
                <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1 pr-4">
                    ...
                    <div role="progressbar" aria-valuenow={progress} aria-valuemin={0} aria-valuemax={100} className="w-full h-1.5 bg-zinc-100/80 dark:bg-zinc-800/80 rounded-full flex overflow-hidden">
