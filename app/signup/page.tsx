        ...
        <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4">
            <div className="w-full max-w-md bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm p-6 sm:p-8">
                <div className="text-center mb-6 sm:mb-8">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-zinc-900 dark:text-white">Create Account</h1>
                    <p className="text-sm sm:text-base text-zinc-500 dark:text-zinc-400 mt-2">Start tracking your CA journey</p>
                </div>
